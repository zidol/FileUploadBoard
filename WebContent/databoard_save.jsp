...
<body>
	<%
		String fileurl = "C:/study/ajh/workspace/Ch11/upload/";
		...
		MultipartRequest multi = new MultipartRequest(request, fileurl, maxsize, encType, 
		...
		try {
			...
			if(cnt>0) {
				if(filename != null) {
					...
					out.println("<script> alert('업로드 파일은 없으며 글은 업로드 되었습니다.'); location.href='databoard_list.jsp';</script>");
				}
			} else {
